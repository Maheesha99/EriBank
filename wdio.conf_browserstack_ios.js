...
exports.config = {
    ...
    capabilities: [{
        name: conf.sessionName_browserstack_ios,
        build: conf.build,
        project: conf.project,
        device: conf.deviceName_browserstack_ios,
        app: conf.app_browserstack_ios,
        //caps.setCapability("os_version", "11");
        'browserstack.appium_version': conf.appium_version,
        "browserstack.video": conf.browserstack_video,
        executionType: 'browserstack_ios' //local_android,local_ios,browserstack_android,browserstack_ios
    }],
