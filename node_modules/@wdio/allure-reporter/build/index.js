var configFile = require('../../../../Utils/conf');
"use strict";
...
class AllureReporter extends _reporter.default {
  ...
  setCaseParameters(cid) {
    ...
    if (!this.isMultiremote) {
      ...
      //added my maheesha
      if(this.capabilities.executionType==undefined){
        this.capabilities.executionType='local_android'
      }
      switch (this.capabilities.executionType.toLowerCase()) {
        case 'local_android':
          currentTest.addParameter('argument', 'Device', configFile.deviceName_local_android);
          currentTest.addParameter('argument', 'Platform Version', configFile.platformVersion_local_android);
          break;
        case 'local_ios':
          currentTest.addParameter('argument', 'Device', configFile.deviceName_local_ios);
          currentTest.addParameter('argument', 'Platform Version', configFile.platformVersion_local_ios);
          break;
        case 'browserstack_android':
          currentTest.addParameter('argument', 'Device', configFile.deviceName_browserstack_android);
          currentTest.addParameter('argument', 'Platform Version', configFile.platformVersion_browserstack_android);
          break;
        case 'browserstack_ios':
          currentTest.addParameter('argument', 'Device', configFile.deviceName_browserstack_ios);
          currentTest.addParameter('argument', 'Platform Version', configFile.platformVersion_browserstack_ios);
          break;
